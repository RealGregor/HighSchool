...
{
    public partial class SearchTiresLayout : UserControl
    {
        ...
        private void btnApplyFilters_Click(object sender, EventArgs e) {
            ...
            formMainAdmin.mainForm.FunctionSummoner(41, category:"Tire", technicalDescription: technicalDescription, priceMin: priceMin, priceMax: priceMax);
        }
        ...
        private void tiresData_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e) {
            ...
            tireViewForm = new TireViewFormAdmin(autoPart);
            tireViewForm.Show();
        }
    }
}
