...
namespace LeaveMeAlone
{
    public partial class FiltersLayout : UserControl
    {
        ...
        private void btnApplyFilters_Click(object sender, EventArgs e) {
            ...
            formMain.mainForm.FunctionSummoner(38, category:"Filter", technicalDescription: technicalDescription, priceMin: priceMin, priceMax: priceMax);
        }
        ...
        private void tiresData_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e) {
            ...
            filterViewForm = new FilterViewForm(autoPart);
            filterViewForm.Show();
        }
    }
}
