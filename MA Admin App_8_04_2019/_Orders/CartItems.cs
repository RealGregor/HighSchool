...
namespace LeaveMeAlone._Groups
{
    public partial class CartItems : UserControl
    {
        ...
        private TireViewFormAdmin tireViewForm;
        private LightViewFormAdmin lightViewForm;
        private OilViewFormAdmin oilViewForm;
        ...
        private void cartData_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e) {
            ...
            switch (cartItem.cartItem.AutoPart.Category) {
                case "Tire":
                    ...
                    tireViewForm = new TireViewFormAdmin(cartItem, true);
                    tireViewForm.Show();
                    break;
                case "Light":
                    ...
                    lightViewForm = new LightViewFormAdmin(cartItem, true);
                    lightViewForm.Show();
                    break;
                case "Oil":
                    if (oilViewForm != null) {
                    ...
                    oilViewForm = new OilViewFormAdmin(cartItem, true);
                    oilViewForm.Show();
                    break;
                case "Filter":
                    ...
                    filterViewForm = new FilterViewFormAdmin(cartItem, true);
                    filterViewForm.Show();
                    break;
            }
