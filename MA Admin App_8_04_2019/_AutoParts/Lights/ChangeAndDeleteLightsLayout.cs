...
{
    public partial class ChangeAndDeleteLightsLayout : UserControl
    {
        ...
        public ChangeAndDeleteLightsLayout()
        {
            InitializeComponent();
        ...
        private void changeTireInformationButton_Click(object sender, EventArgs e) {
            if (!txtLightID.Text.Trim().Equals(originalAutoPartID)) {
        ...
        private void deleteTireInformationButton_Click(object sender, EventArgs e) {
            ...
            if (string.IsNullOrEmpty(txtLightID.Text.Trim())) {
                deleteAutoPart.ID = autoPart.ID;
            } else {
                deleteAutoPart.ID = new Guid(txtLightID.Text);
            }
