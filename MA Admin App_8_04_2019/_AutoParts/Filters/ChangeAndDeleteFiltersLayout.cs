...
using LeaveMeAlone._AutoParts.Filters;

namespace LeaveMeAlone
{
    public partial class ChangeAndDeleteFiltersLayout : UserControl
    {
        ...
        private FilterSizeInformation filterInfo;

        public ChangeAndDeleteFiltersLayout()
        {
            InitializeComponent();
        ...
        public void SetAutoPartData(AutoPartViewModel autoPart) {
            ...
            if (!string.IsNullOrEmpty(autoPart.TechnicalDetails)) {
                ...
                if (technicalDetails.ContainsKey("Oblika filtra")) {
                    if (technicalDetails["Oblika filtra"].Equals("Okrogel")) {
                        roundFilter.Checked = true;
                        ...
                        filterInfo = new FilterSizeInformation {
                            Diameter = txtDiameter.Text,
                            Round = true
                        };
                    } else {
                        roundFilter.Checked = false;
        ...
        private void changeAutoPart_Click(object sender, EventArgs e) {
            ...
            roundFilter.Enabled = true;
            roundFilter.Checked = false;

            deleteLightButton.Visible = false;
            changeLightButton.Visible = true;
        ...
        private void deleteAutoPartButton_Click(object sender, EventArgs e) {
            ...
            roundFilter.Enabled = false;

            txtAdminPassword.Enabled = true;
            txtTireID.Enabled = true;

            deleteLightButton.Visible = true;
            changeLightButton.Visible = false;
        ...
        private void roundFilter_CheckedChanged(object sender, EventArgs e) {
            if (roundFilter.Checked) {
                txtDiameter.Enabled = true;
                if (filterInfo.Round) {
                    txtDiameter.Text = filterInfo.Diameter;
                }
            ...
            if (!filterInfo.Round) {
                txtLength.Text = filterInfo.Length;
                txtWidth.Text = filterInfo.Width;
                txtHeight.Text = filterInfo.Height;
            }
