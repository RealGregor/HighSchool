...
{
    public partial class ChangeAndDeleteTiresLayout : UserControl
    {
        ...
        public ChangeAndDeleteTiresLayout()
        {
            InitializeComponent();
        ...
        private void changeAutoPart_Click(object sender, EventArgs e) {
            ...
            deleteTireButton.Visible = false;
