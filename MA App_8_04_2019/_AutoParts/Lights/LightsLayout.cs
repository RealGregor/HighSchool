...
namespace LeaveMeAlone
{
    public partial class LightsLayout : UserControl
    {
        ...
        private LightViewForm lightViewForm;//change this
        ...
        private void btnApplyFilters_Click(object sender, EventArgs e) {
            ...
            formMain.mainForm.FunctionSummoner(38, category:"Light", technicalDescription: technicalDescription, priceMin: priceMin, priceMax: priceMax);
        }
        ...
        private void lightsData_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e) {
            ...
            lightViewForm = new LightViewForm(autoPart);
            lightViewForm.Show();
        }
    }
}
