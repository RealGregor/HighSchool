...
{
    public partial class AddFiltersLayout : UserControl
    {
        private ImageFormat format = null;

        public AddFiltersLayout()
        {
            InitializeComponent();
        ...
        private void btnAddTyre_Click(object sender, EventArgs e) {
            ...
            if (roundFilter.Checked) {
                technicalDescription += ",Oblika filtra:Okrogel";
            } else {
                technicalDescription += ",Oblika filtra:Kvadraten";
            }
            try {
                AutoPartViewModel autoPart = new AutoPartViewModel {
                    ...
                    ProducerName = txtProducer.Text.Trim(),
                    TechnicalDetails = technicalDescription,
                    DeliveryDeadline = Convert.ToInt32( txtDeliveryDeadline.Text.Trim()),
