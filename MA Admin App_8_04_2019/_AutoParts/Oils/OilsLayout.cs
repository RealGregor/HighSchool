...
namespace LeaveMeAlone
{
    public partial class OilsLayout : UserControl
    {
        ...
        {
            searchOilsLayout.SetAutoPartsDataControlSource(list);
        }
        public void SetAutoPartData(AutoPartViewModel autoPart)
        {
            changeAndDeleteOilsLayout.SetAutoPartData(autoPart);
        }
        public Guid GetActiveAutoPartID() {
            return changeAndDeleteOilsLayout.GetActiveAutoPartID();
        }
        public void ClearAutoPartData() {
            changeAndDeleteOilsLayout.ClearAutoPartData();
        }
        ...
        private void aboutUsButton_Click(object sender, EventArgs e)
        {
            ...
            addOilsLayout.Visible = true;
            searchOilsLayout.Visible = false;
            changeAndDeleteOilsLayout.Visible = false;
        ...
        private void searchingTiresButton_Click(object sender, EventArgs e)
        {
            ...
            searchOilsLayout.Visible = true;
            addOilsLayout.Visible = false;
            changeAndDeleteOilsLayout.Visible = false;
        ...
        private void changingAndDeletingTiresButton_Click(object sender, EventArgs e)
        {
            ...
            changeAndDeleteOilsLayout.Visible = true;
            addOilsLayout.Visible = false;
            searchOilsLayout.Visible = false;
