...
{
    public partial class SearchOilsLayout : UserControl
    {
        ...
        private void btnApplyFilters_Click(object sender, EventArgs e) {
            ...
            formMainAdmin.mainForm.FunctionSummoner(41, category:"Oil", technicalDescription: technicalDescription, priceMin: priceMin, priceMax: priceMax);
        }
        ...
        private void tiresData_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e) {
            ...
            oilViewForm = new OilViewFormAdmin(autoPart);
            oilViewForm.Show();
        }
    }
}
